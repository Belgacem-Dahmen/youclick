  ...
  <header class="bg-gray-100">
    ...
    >
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <RouterLink to="" class="text-sm/6 font-semibold text-gray-900">Features</RouterLink>
        <RouterLink to="" class="text-sm/6 font-semibold text-gray-900"
          >Marketplace</RouterLink>
        <RouterLink to="" class="text-sm/6 font-semibold text-gray-900">Company</RouterLink>
      </PopoverGroup>
